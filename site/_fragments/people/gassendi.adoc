...
era: early-modern
nationality: french
sciences: [philosophy, physics, astronomy]
science: philosophy
related: [democritus, newton]
---
= Pierre Gassendi (1592-1655)
ifndef::env-site[:imagesdir: ../../assets/images/people]
ifdef::env-site[:imagesdir: /sindri-labs/assets/images/people]
:page-image: gassendi.jpg
:page-image-credit: "Portrait by Louis-Édouard Rioult (circa 1846-1847). Public domain via Wikimedia Commons."
...
_**↑ {all-people}**_ | _**Featured in:**_ _**{featured-essay}**_ · _**{featured-companion}**_ | _**{see-democritus}**_ · _**{see-newton}**_
