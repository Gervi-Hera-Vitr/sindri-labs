...
era: antiquity
nationality: greek
sciences: [philosophy, ethics, mathematics]
science: philosophy
---
= Plato of Athens (428-348 BCE)
ifndef::env-site[:imagesdir: ../../assets/images/people]
ifdef::env-site[:imagesdir: /sindri-labs/assets/images/people]
:page-image: plato.jpg
:page-image-credit: "Roman marble bust, 1st century copy of 4th-century BCE Greek original by Silanion. CC-BY 2.5 via Wikimedia Commons."
