...
*Anton*: `Captain Lugaru`, 16 -- "the world moves when he decides for action, never before"::
// suppress inspection "AsciiDocLinkResolve"
The link:semester[Current Semester] is "Fall-Winter 2025."

*Zoey*: `ZueZue kHavok`, 2 -- "nothing touches the floor until she leaves; then stuff rains down"::
Potty Training 101.
