...
:page-layout: single
:page-classes: wide
:cappy-school: https://github.com/Gervi-Hera-Vitr/[Gervi Héra Vitr,window=_blank]
...
My School organization is {cappy-school} from *Mímis Gildi* that my parents have registered with the state.
