...
:on-prev: link:/sindri-labs/mathematics/2025/07/05/On-Mathematics-Category-Theory.html[Part 4: Category Theory]
:on-next: link:/sindri-labs/mathematics/2025/07/07/On-Computation-Theory.html[Part 6: Computation Theory]
:see-bernays: link:/sindri-labs/fragments/people/bernays/[Paul Bernays]
