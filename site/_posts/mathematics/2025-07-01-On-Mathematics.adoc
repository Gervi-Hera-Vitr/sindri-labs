...
:page-layout: single
:page-classes: wide
:page-permalink: /on-mathematics/
:youtube-channel-domain-of-science: https://www.youtube.com/@ScienceMaps[Domain of Science (Science Maps),window=_blank]
:youtube-the-map-of-math: https://youtu.be/OmJ-4B-mS-Y[The Map of Mathematics,window=_blank]
:part-1: link:/sindri-labs/mathematics/2025/07/02/On-Foundations-Of-Mathematics.html[Part 1: Foundations & Reason]
:part-2: link:/sindri-labs/mathematics/2025/07/03/On-Mathematics-Set-Theory.html[Part 2: Set Theory]
:part-3: link:/sindri-labs/mathematics/2025/07/04/On-Mathematics-Complexity-Theory.html[Part 3: Complexity Theory]
:part-4: link:/sindri-labs/mathematics/2025/07/05/On-Mathematics-Category-Theory.html[Part 4: Category Theory]
:part-5: link:/sindri-labs/mathematics/2025/07/06/On-Godel-Incompleteness-Theorem.html[Part 5: On Godel's Incompleteness Theorem]
:part-6: link:/sindri-labs/mathematics/2025/07/07/On-Computation-Theory.html[Part 6: Computation Theory]
:part-7: link:/sindri-labs/mathematics/2025/07/11/On-Set-Theory.html[Part 7: Russell's Paradox]
...
None of "you go do that when you have this."
But a real understanding of a topic requires *_no mechanical memorization_*.
...
{nbsp} {youtube-channel-domain-of-science}. +
It offered an overview video: +
{nbsp} {youtube-the-map-of-math}. +
...
As a researcher, he's featured in articles praising the "Map of Physics" visualization -- e.g., on Sciencealert.com and Physics says what? (Blog)
And this channel is listed among the top science channels for quantum physics by blogs and curators.
...
The lecturer's tone balances a rigorous science background with friendly delivery, appealing to both students and science enthusiasts.
