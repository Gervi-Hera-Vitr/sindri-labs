...
:captain-fn: footnote:cptlugaru[Captain {lugaru} as the first prodigy]
:curriculum-folder: https://github.com/Gervi-Hera-Vitr/sindri-labs/tree/main/curriculum[/sindri-labs/tree/main/curriculum,window=_blank,opts=nofollow]
...
State and Federal offer secondary assessment systems that kids enjoy beating. +
...
All learning is contextualized in real work on real _assets_ and is completely self-paced. +
...
image::/sindri-labs/assets/images/image-posts.jpg[Gervi Héra Vitr kids keep a diary,width=80%,align=center]
{nbsp}
...
- and, *Reflection*{captain-fn} by introspection and retrospection (journals, essays, feedback, etc.)
...
- Social development trumps intellectual development, this is also more challenging for homeschooled kids.

Considering these factors, we use a _"learning trail"_ approach to learning:

- Satisfy just the minimum amount of time the state requires for children to learn each week;
