...
:page-classes: wide
:gervi-hera-vitr: https://github.com/Gervi-Hera-Vitr/[Gervi-Hera-Vitr,window=_blank]

Hacker. Builder. Learner.

I learn by building. Most of my work lives here: {gervi-hera-vitr}
...
image::/sindri-labs/assets/images/image-captain.jpg[Captain,width="55%",align="right",link=https://github.com/CaptainLugaru]
...
- **ML and Python** -- honing my skills in Python and data science libraries; attempting the functional programming paradigm in Python having previously mastered Kotlin, Java, and TypeScript.
