...
All of this is just some theoretical ramblings, smoke and mirrors, pretty talking
-- *_UNLESS_ it is put into practice*!
Here are our personal examples:

- link:./examples/rdd13r-saboteurs.adoc[`rdd13r`'s battle on his saboteurs].
- link:./examples/captain-saboteurs.adoc[`lugaru`s battle on his saboteurs].
